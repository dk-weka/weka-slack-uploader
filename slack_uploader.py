...
def upload_file_to_slack(file_path, initial_comment, slack_token, channel_id, thread_ts=None, broadcast=False):
    """
...
def main():
    ...
    upload_file_to_slack(args.file, args.comment, args.token, args.channel, args.thread_ts, args.broadcast)
